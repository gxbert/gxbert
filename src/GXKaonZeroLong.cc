...
//
//
// $Id: GXKaonZeroLong.cc 67971 2013-03-13 10:13:24Z gcosmo $
//
// 
// ----------------------------------------------------------------------
...
GXKaonZeroLong* GXKaonZeroLong::theInstance = 0;

GXKaonZeroLong* GXKaonZeroLong::Definition()
{
...
/*
 ...
 // create decay channels
  ...
  // kaon0L -> pi0 + pi0 + pi0
  mode[0] = new GXPhaseSpaceDecayChannel("kaon0L",0.1952,3,"pi0","pi0","pi0");
  // kaon0L -> pi0 + pi+ + pi-
  mode[1] = new GXPhaseSpaceDecayChannel("kaon0L",0.1254,3,"pi0","pi+","pi-");
...
*/
  ...
  theInstance = reinterpret_cast<GXKaonZeroLong*>(anInstance);
  return theInstance;
}

GXKaonZeroLong*  GXKaonZeroLong::KaonZeroLongDefinition()
{
  return Definition();
}

GXKaonZeroLong*  GXKaonZeroLong::KaonZeroLong()
{
  return Definition();
}
