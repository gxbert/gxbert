...
G4double GXHadPhaseSpaceKopylov::BetaKopylov(G4int K) const {
  ...
  if ( loopCounter >= maxNumberOfLoops ) {
    ...
    G4Exception( " GXHadPhaseSpaceKopylov::BetaKopylov ", "HAD_KOPYLOV_001", JustWarning, ed );
  }
