...
G4double GXVHadDecayAlgorithm::TwoBodyMomentum(G4double M0, G4double M1,
					       G4double M2) const {
...
G4double GXVHadDecayAlgorithm::UniformTheta() const {
  return std::acos(2.0*G4UniformRand() - 1.0);
}

G4double GXVHadDecayAlgorithm::UniformPhi() const {
