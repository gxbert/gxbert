...
G4InuclParticle::G4InuclParticle(const GXParticleDefinition* pd,
...
namespace {
  static const GXDynamicParticle empty;		// To zero out everything
}

void G4InuclParticle::setDefinition(const GXParticleDefinition* pd) {
