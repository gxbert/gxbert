...
//
//
// $Id: GXPDGCodeChecker.cc 105720 2017-08-16 12:38:10Z gcosmo $
//
// 
// ----------------------------------------------------------------------
...
/////////////
GXPDGCodeChecker::GXPDGCodeChecker()
...
/////////////
G4int  GXPDGCodeChecker::CheckPDGCode( G4int    PDGcode, 
...
/////////////
G4int GXPDGCodeChecker::CheckForBaryons()
{
...
#ifdef G4VERBOSE
    if (verboseLevel>0) {
      G4cout << " GXPDGCodeChecker::CheckPDGCode : ";
...
/////////////
G4int GXPDGCodeChecker::CheckForMesons()
{
  G4int   tempPDGcode = code;
...
/////////////
G4int GXPDGCodeChecker::CheckForDiQuarks()
{
  if ((quark1 ==0) || (quark2 ==0) || (quark3 !=0)) {
    // quark3 should be 0
    //  --- code is wrong 
...
/////////////
G4int GXPDGCodeChecker::CheckForQuarks()
{
  quark1 = std::abs(code);
...
/////////////
G4bool GXPDGCodeChecker::CheckCharge(G4double thePDGCharge) const
{
  // check charge
...
#ifdef G4VERBOSE
    if (verboseLevel>0) {
      G4cout << " GXPDGCodeChecker::CheckCharge  : ";
...
/////////////
G4int GXPDGCodeChecker::CheckForNuclei()
{
...
/////////////
void GXPDGCodeChecker::GetDigits(G4int PDGcode)
{
