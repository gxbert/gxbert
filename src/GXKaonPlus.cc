...
//
//
// $Id: GXKaonPlus.cc 67971 2013-03-13 10:13:24Z gcosmo $
//
// 
// ----------------------------------------------------------------------
...
GXKaonPlus* GXKaonPlus::theInstance = 0;

GXKaonPlus* GXKaonPlus::Definition()
{
...
/*
 ...
 // create decay channels
  ...
  // kaon+ -> mu+ + nu_mu
  mode[0] = new GXPhaseSpaceDecayChannel("kaon+",0.6355,2,"mu+","nu_mu");
  // kaon+ -> pi+ + pi0
...
*/
  ...
  theInstance = reinterpret_cast<GXKaonPlus*>(anInstance);
  return theInstance;
}

GXKaonPlus*  GXKaonPlus::KaonPlusDefinition()
{
  return Definition();
}

GXKaonPlus*  GXKaonPlus::KaonPlus()
{
  return Definition();
}
