...
//
//
// $Id: GXPionMinus.cc 67971 2013-03-13 10:13:24Z gcosmo $
//
// 
// ----------------------------------------------------------------------
...
GXPionMinus* GXPionMinus::theInstance = 0;

GXPionMinus* GXPionMinus::Definition()
{
 ...
 //create Decay Table
  ...
  // pi- -> mu- + anti_nu_mu
  GXVDecayChannel* mode = new GXPhaseSpaceDecayChannel("pi-",1.00,2,"mu-","anti_nu_mu");
  table->Insert(mode);

   anInstance->SetDecayTable(table);
  }
  theInstance = reinterpret_cast<GXPionMinus*>(anInstance);
  return theInstance;
}

GXPionMinus*  GXPionMinus::PionMinusDefinition()
{
  return Definition();
}

GXPionMinus*  GXPionMinus::PionMinus()
{
  return Definition();
}
