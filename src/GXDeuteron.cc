...
//
//
// $Id: GXDeuteron.cc 69557 2013-05-08 12:01:40Z gcosmo $
//
// 
// ----------------------------------------------------------------------
...
GXDeuteron* GXDeuteron::theInstance = 0;

GXDeuteron* GXDeuteron::Definition()
{
  ...
  theInstance = reinterpret_cast<GXDeuteron*>(anInstance);
  return theInstance;
}

GXDeuteron*  GXDeuteron::DeuteronDefinition()
{
  return Definition();
}

GXDeuteron*  GXDeuteron::Deuteron()
{
  return Definition();
}
