...
//
//
// $Id: GXHe3.cc 69557 2013-05-08 12:01:40Z gcosmo $
//
// 
// ----------------------------------------------------------------------
...
GXHe3* GXHe3::theInstance = 0;

GXHe3* GXHe3::Definition()
{
  ...
  theInstance = reinterpret_cast<GXHe3*>(anInstance);
  return theInstance;
}

GXHe3*  GXHe3::He3Definition()
{
  return Definition();
}
