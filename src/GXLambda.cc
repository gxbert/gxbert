...
//
//
// $Id: GXLambda.cc 67971 2013-03-13 10:13:24Z gcosmo $
//
// 
// ----------------------------------------------------------------------
...
GXLambda* GXLambda::theInstance = 0;

GXLambda* GXLambda::Definition()
{
  ...
  //             shortlived      subType    anti_encoding
    ...
    // lambda -> proton + pi-
    mode[0] = new GXPhaseSpaceDecayChannel("lambda",0.639,2,"proton","pi-");
    // lambda -> neutron + pi0
    mode[1] = new GXPhaseSpaceDecayChannel("lambda",0.358,2,"neutron","pi0");
  ...
  theInstance = reinterpret_cast<GXLambda*>(anInstance);
  return theInstance;
}

GXLambda*  GXLambda::LambdaDefinition()
{ 
  return Definition();
}

GXLambda*  GXLambda::Lambda()
{ 
  return Definition();
}
