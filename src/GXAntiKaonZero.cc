...
//
//
// $Id: GXAntiKaonZero.cc 67971 2013-03-13 10:13:24Z gcosmo $
//
// 
// ----------------------------------------------------------------------
...
GXAntiKaonZero* GXAntiKaonZero::theInstance = 0;

GXAntiKaonZero* GXAntiKaonZero::Definition()
{
 ...
 //create Decay Table
  ...
  // kaon0 -> Kaon0L
  mode[0] = new GXPhaseSpaceDecayChannel("anti_kaon0",0.500,1,"kaon0L");
  // kaon0 -> Kaon0S
  mode[1] = new GXPhaseSpaceDecayChannel("anti_kaon0",0.500,1,"kaon0S");
  ...
  theInstance = reinterpret_cast<GXAntiKaonZero*>(anInstance);
  return theInstance;
}

GXAntiKaonZero*  GXAntiKaonZero::AntiKaonZeroDefinition()
{
  return Definition();
}

GXAntiKaonZero*  GXAntiKaonZero::AntiKaonZero()
{
  return Definition();
}
