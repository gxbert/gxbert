...
//
//
// $Id: GXProton.cc 69557 2013-05-08 12:01:40Z gcosmo $
//
// 
// ----------------------------------------------------------------------
...
// ###                           PROTON                               ###
// ######################################################################
GXProton* GXProton::theInstance = 0;

GXProton* GXProton::Definition()
{
  ...
  theInstance = reinterpret_cast<GXProton*>(anInstance);
  return theInstance;
}

GXProton*  GXProton::ProtonDefinition()
{
  return Definition();
}

GXProton*  GXProton::Proton()
{
  return Definition();
}
