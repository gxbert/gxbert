...
//
//
// $Id: GXNucleiPropertiesTheoreticalTable.hh 72955 2013-08-14 14:23:14Z gcosmo $
//
// 
// ------------------------------------------------------------
...
#ifndef GXNucleiPropertiesTheoreticalTable_h
#define GXNucleiPropertiesTheoreticalTable_h 1

#include "globals.hh"

class GXNucleiProperties;

class GXNucleiPropertiesTheoreticalTable 
{
private:
  
  // Default constructor 
  GXNucleiPropertiesTheoreticalTable(){};
