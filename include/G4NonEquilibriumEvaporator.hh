...
// 20130924  Add local pointer to GXPow for convenience
...
public:
  ...
  virtual void deExcite(const GXFragment& target, G4CollisionOutput& output);

private:
  G4InuclSpecialFunctions::paraMaker theParaMaker;
  GXPow* theGXPow;			// Convenient reference to singleton
