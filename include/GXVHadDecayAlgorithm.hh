...
#ifndef GXVHadDecayAlgorithm_HH
#define GXVHadDecayAlgorithm_HH 1
...
public:
  GXVHadDecayAlgorithm(const G4String& algName, G4int verbose=0)
    : name(algName), verboseLevel(verbose) {;}
  virtual ~GXVHadDecayAlgorithm() {;}
