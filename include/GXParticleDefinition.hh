...
//
//
// $Id: GXParticleDefinition.hh 106143 2017-09-14 06:34:42Z gcosmo $
//
// 
// ------------------------------------------------------------
...
#ifndef GXParticleDefinition_h
#define GXParticleDefinition_h 1
...
//TK for GXBERT
//typedef G4PDefManager GXParticleDefinitionSubInstanceManager;
...
class GXParticleDefinition 
{
 ...
 public: // With Description
  ...
  // Only one type of constructor can be used for GXParticleDefinition.
  ...
  // of special class derived from GXParticleDefinition.
  // see G4ParticleTypes for detail 
 
      GXParticleDefinition(const G4String&  aName,  
                           G4double         mass,     
			   G4double         width,
                           G4double         charge,   
			   G4int            iSpin,
      ...
      GXDecayTable* GetDecayTable() const;
      void          SetDecayTable(GXDecayTable* aDecayTable); 
        // Set/Get Decay Table
      ...
      GXParticleTable* GetParticleTable() const;
      ...
      G4int operator==(const GXParticleDefinition &right) const;
      G4int operator!=(const GXParticleDefinition &right) const;
...
*/
 ...
 private:
  ...
  protected:
      ...
      //
      GXParticleDefinition(const GXParticleDefinition &right);
      GXParticleDefinition();
  ...
  private:
      ...
      //
      const GXParticleDefinition & operator=(const GXParticleDefinition &r);
  ...
  private:
      ...
      GXDecayTable *theDecayTable;
      //  Points DecayTable 

   private:

      GXParticleTable* theParticleTable;
...
#include "GXParticleDefinition.icc"
