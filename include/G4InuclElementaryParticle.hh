...
// 20110721  M. Kelsey -- Add constructors to take GXParticleDefinition as
...
public:
  ...
  G4InuclElementaryParticle(const GXDynamicParticle& dynPart,
  ...
  // WARNING:  This may create a particle without a valid type code!
  void fill(const G4LorentzVector& mom, const GXParticleDefinition* pd,
	    Model model=DefaultModel);
  ...
  static G4int type(const GXParticleDefinition* pd);
...
protected:
  ...
  static const GXParticleDefinition* makeDefinition(G4int ityp);
};        
