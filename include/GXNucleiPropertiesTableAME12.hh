...
//
//
// $Id: GXNucleiPropertiesTableAME12.hh 72955 2013-08-14 14:23:14Z gcosmo $
//
// -------------------------------------------------------------------
//
//      File name:     GXNucleiPropertiesTableAME12.cc 
//
...
//                     based on GXNucleiPropertiesTableAME03
//
//      Modifications: 
// 

#ifndef GXNucleiPropertiesTableAME12_h
#define GXNucleiPropertiesTableAME12_h  1
...
class GXNucleiPropertiesTableAME12 
{
private:
  
  // Default constructor - this class should exist only once!
  GXNucleiPropertiesTableAME12();
...
public:
  ...
  // Other Operations 
  // all methods are private and can be used only by GXNucleiProperties

  friend class GXNucleiProperties;  
...
private:
  ...
  // The inicialization is Done in GXNucleiPropertiesTableAME12.cc
