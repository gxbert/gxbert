...
#ifndef GXHadPhaseSpaceGenbod_HH
#define GXHadPhaseSpaceGenbod_HH 1

#include "GXVHadPhaseSpaceAlgorithm.hh"


class GXHadPhaseSpaceGenbod : public GXVHadPhaseSpaceAlgorithm {
public:
  GXHadPhaseSpaceGenbod(G4int verbose=0);
  virtual ~GXHadPhaseSpaceGenbod() {;}
...
#endif	/* GXHadPhaseSpaceGenbod_HH */
