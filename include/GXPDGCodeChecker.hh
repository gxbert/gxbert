...
//
//
// $Id: GXPDGCodeChecker.hh 67971 2013-03-13 10:13:24Z gcosmo $
//
// 
// ------------------------------------------------------------
...
#ifndef GXPDGCodeChecker_h
#define GXPDGCodeChecker_h 1

#include "globals.hh"
#include "G4ios.hh"

class GXPDGCodeChecker 
{
...
inline
  G4int  GXPDGCodeChecker::GetQuarkContent(G4int flavor) const
{
  G4int value = 0;
...
inline
  G4int  GXPDGCodeChecker::GetAntiQuarkContent(G4int flavor) const
{
  G4int value = 0;
  if ((flavor>=0)&&(flavor<NumberOfQuarkFlavor)) {
...
inline
  G4int GXPDGCodeChecker::GetQuarkFlavor(G4int idx) const
{
  G4int value;
...
inline
  G4int GXPDGCodeChecker::GetExotic() const
{
  return exotic;
}

inline
  G4int GXPDGCodeChecker::GetRadial() const
{
  return radial;
}

inline
  G4int GXPDGCodeChecker::GetMultiplet() const
{
  return multiplet;
}

inline
  G4int GXPDGCodeChecker::GetSpin() const
{
  return spin;
}

inline
  G4bool GXPDGCodeChecker::IsAntiParticle() const
{
  return (code <0);
}

inline 
  void GXPDGCodeChecker::SetVerboseLevel(G4int value)
{
   verboseLevel = value;
}

inline 
  G4int GXPDGCodeChecker::GetVerboseLevel() const
{
   return verboseLevel;
}
