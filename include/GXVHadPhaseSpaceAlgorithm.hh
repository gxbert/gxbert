...
#ifndef GXVHadPhaseSpaceAlgorithm_HH
#define GXVHadPhaseSpaceAlgorithm_HH 1
...
class GXVHadPhaseSpaceAlgorithm : public GXVHadDecayAlgorithm {
public:
  GXVHadPhaseSpaceAlgorithm(const G4String& algName, G4int verbose=0)
    : GXVHadDecayAlgorithm(algName, verbose) {;}
  virtual ~GXVHadPhaseSpaceAlgorithm() {;}
...
#endif	/* GXVHadPhaseSpaceAlgorithm_HH */
